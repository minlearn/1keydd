...
`printf "#%0.s" {1..78}`
 ...
 -----------------------------   | github): https://github.com/minlearn/inst
  -t) target *  -m) debmirror    | social): https://github.com/minlearn/discuss
